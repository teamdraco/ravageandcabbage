...
@OnlyIn(Dist.CLIENT)
public class CabbageRavagerModel extends AgeableModel<CabbageRavagerEntity> {
   ...
   public void setRotationAngles(CabbageRavagerEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
