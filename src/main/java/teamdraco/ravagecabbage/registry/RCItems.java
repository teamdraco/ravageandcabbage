...
import teamdraco.ravagecabbage.common.items.*;
...
public class RCItems {
    ...
    public static final RegistryObject<Item> ILL_CABBAGE = REGISTER.register("ill_cabbage", () -> new ThrowableIllCabbageItem(new Item.Properties().tab(RavageAndCabbage.GROUP)));
