package superlord.ravagecabbage.entity.ai;
...
public class ThrowCabbageGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal {
   ...
   public ThrowCabbageGoal(T mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
      this.entity = mob;
   ...
   public boolean shouldExecute() {
      return this.entity.getAttackTarget() == null ? false : this.isCabbageInMainhand();
   }

   protected boolean isCabbageInMainhand() {
      return this.entity.func_233634_a_(item -> item instanceof ThrowableCabbageItem);
   }
   ...
   public boolean shouldContinueExecuting() {
      return (this.shouldExecute() || !this.entity.getNavigator().noPath()) && this.isCabbageInMainhand();
   }
      ...
      if (livingentity != null) {
         ...
         if (this.entity.isHandActive()) {
            if (!flag && this.seeTime < -60) {
               ...
               if (i >= 20) {
                  this.entity.resetActiveHand();
                  this.entity.attackEntityWithRangedAttack(livingentity, 8);
